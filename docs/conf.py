# -*- coding: utf-8 -*-
#
# flo documentation build configuration file, created by
...
latex_documents = [
  ('index', 'flo.tex', u'flo Documentation',
...
texinfo_documents = [
  ('index', 'flo', u'flo Documentation',
   u'Dean Malmgren', 'flo', 'One line description of project.',
   'Miscellaneous'),
]
